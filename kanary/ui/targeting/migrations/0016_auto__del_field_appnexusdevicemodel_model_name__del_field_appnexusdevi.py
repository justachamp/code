...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AppNexusDeviceModel.model_name'
        db.delete_column(u'targeting_appnexusdevicemodel', 'model_name')

        # Deleting field 'AppNexusDeviceMake.make_name'
        db.delete_column(u'targeting_appnexusdevicemake', 'make_name')


    def backwards(self, orm):
        # Adding field 'AppNexusDeviceModel.model_name'
        db.add_column(u'targeting_appnexusdevicemodel', 'model_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'AppNexusDeviceMake.make_name'
        db.add_column(u'targeting_appnexusdevicemake', 'make_name',
