...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'report_report', (
            ...
            ('campaign', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['campaign.Campaign'], unique=True, null=True, blank=True)),
            ('strategy', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['campaign.Strategy'], unique=True, null=True, blank=True)),
        ...
        # Adding unique constraint on 'Report', fields ['account', 'slug']
        db.create_unique(u'report_report', ['account_id', 'slug'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Report', fields ['account', 'slug']
        db.delete_unique(u'report_report', ['account_id', 'slug'])
    ...
    models = {
        ...
        u'campaign.campaign': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'9e8f0d4afbbf1137d33807377573899d5fdbb53d'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'campaign.strategy': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'881cf28e3e3f1cbab1f9d8b54d781c41cd2db821'", 'unique': 'True', 'max_length': '128'}),
