...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportStrategy.commission_value'
        db.add_column(u'report_reportstrategy', 'commission_value',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.commission_value'
        db.add_column(u'report_reportadvert', 'commission_value',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportStrategy.commission_value'
        db.delete_column(u'report_reportstrategy', 'commission_value')

        # Deleting field 'ReportAdvert.commission_value'
        db.delete_column(u'report_reportadvert', 'commission_value')
