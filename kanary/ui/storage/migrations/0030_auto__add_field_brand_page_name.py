...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Brand.page_name'
        db.add_column(u'storage_brand', 'page_name',
                      self.gf('django.db.models.fields.CharField')(default='Default Page Name', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Brand.page_name'
        db.delete_column(u'storage_brand', 'page_name')
