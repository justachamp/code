...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'campaign_strategy_exchanges'))


    def backwards(self, orm):
        # Adding M2M table for field exchanges on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_exchanges')
        ...
        db.create_unique(m2m_table_name, ['strategy_id', 'exchange_id'])
