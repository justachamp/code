...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.strategy_1'
        db.delete_column(u'notification_event', 'strategy_1_id')

        # Deleting field 'Event.campaign_1'
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'notification_event', 'strategy_1',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaign.Strategy'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.campaign_1'
        db.add_column(u'notification_event', 'campaign_1',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaign.Campaign'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'campaign.campaign': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'95d5f7e512e9f77ba504e42d259da061ff78fb7d'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'campaign.strategy': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'37390deee4f5f6882952dfa6899277d6ad9ab1b3'", 'unique': 'True', 'max_length': '128'}),
