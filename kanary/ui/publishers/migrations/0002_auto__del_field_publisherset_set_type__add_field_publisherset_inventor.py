...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renamig field 'PublisherSet.set_type' -> 'PublisherSet.inventory'
        db.rename_column(u'publishers_publisherset', 'set_type', 'inventory')

        # Adding field 'PublisherSet.is_network'
        db.add_column(u'publishers_publisherset', 'is_network',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Renamig field 'PublisherSet.inventory' -> 'PublisherSet.set_type'
        db.rename_column(u'publishers_publisherset', 'inventory', 'set_type')

        # Deleting field 'PublisherSet.is_network'
        db.delete_column(u'publishers_publisherset', 'is_network')
