...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        Event = orm['notification.Event']
        ContentType = orm['contenttypes.ContentType']

        # use obj_1 generic field instead of campaign_1 and strategy_1

        for event in Event.objects.all():
            if event.campaign_1 and event.strategy_1:
                event.content_type_1 = ContentType.objects.get(model='strategy')
                event.object_id_1 = event.strategy_1.pk
                event.content_type_2 = ContentType.objects.get(model='campaign')
                event.object_id_2 = event.campaign_1.pk
                event.save()
            elif event.campaign_1:
                event.content_type_1 = ContentType.objects.get(model='campaign')
                event.object_id_1 = event.campaign_1.pk
                event.save()
            elif event.strategy_1:
                event.content_type_1 = ContentType.objects.get(model='strategy')
                event.object_id_1 = event.strategy_1.pk
                event.save()
    ...
    models = {
        ...
        u'campaign.campaign': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'2af845d2d3ff65205c5b2f7b5e56c9b8643d5504'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'campaign.strategy': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'96a904ff57e2f7d39c12f1fc473cd26379644f77'", 'unique': 'True', 'max_length': '128'}),
