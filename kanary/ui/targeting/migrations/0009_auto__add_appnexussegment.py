...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppNexusSegment'
        db.create_table(u'targeting_appnexussegment', (
        ...
        db.send_create_signal('targeting', ['AppNexusSegment'])


    def backwards(self, orm):
        # Deleting model 'AppNexusSegment'
        db.delete_table(u'targeting_appnexussegment')
