...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Campaign', fields ['is_deleted']
        db.create_index(u'campaign_campaign', ['is_deleted'])

        # Adding index on 'Advert', fields ['is_deleted']
        db.create_index(u'campaign_advert', ['is_deleted'])

        # Adding index on 'Strategy', fields ['is_deleted']
        db.create_index(u'campaign_strategy', ['is_deleted'])


    def backwards(self, orm):
        # Removing index on 'Strategy', fields ['is_deleted']
        db.delete_index(u'campaign_strategy', ['is_deleted'])

        # Removing index on 'Advert', fields ['is_deleted']
        db.delete_index(u'campaign_advert', ['is_deleted'])

        # Removing index on 'Campaign', fields ['is_deleted']
        db.delete_index(u'campaign_campaign', ['is_deleted'])
