...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Creative.old_image'
        db.delete_column(u'storage_creative', 'old_image')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Creative.old_image'
        raise RuntimeError("Cannot reverse this migration. 'Creative.old_image' and its values cannot be restored.")
    ...
    models = {
        ...
        u'storage.creative': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'177a7211e6ea276c9d4fff8b1ba5ef328c7cd023'", 'unique': 'True', 'max_length': '128'}),
