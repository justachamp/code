...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.selected_metrics'
        db.alter_column(u'report_report', 'selected_metrics', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Report.selected_metrics'
        db.alter_column(u'report_report', 'selected_metrics', self.gf('django.db.models.fields.CharField')(max_length=255))
