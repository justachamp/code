...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # removing inventory will be neither accessible in frontend, not received from bidrequest.
        for inventory in orm['targeting.TargetValue'].objects.filter(category='inventory'):
            if inventory.value in ['Unspecified', '']:
                inventory.delete()
