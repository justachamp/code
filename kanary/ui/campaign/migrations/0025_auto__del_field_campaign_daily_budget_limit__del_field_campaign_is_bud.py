...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campaign.daily_budget_limit'
        db.delete_column(u'campaign_campaign', 'daily_budget_limit')

        # Deleting field 'Campaign.is_budget_distributed_evenly'
        db.delete_column(u'campaign_campaign', 'is_budget_distributed_evenly')


    def backwards(self, orm):
        # Adding field 'Campaign.daily_budget_limit'
        db.add_column(u'campaign_campaign', 'daily_budget_limit',
                      self.gf('ui.fields.BudgetDecimalField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Campaign.is_budget_distributed_evenly'
        db.add_column(u'campaign_campaign', 'is_budget_distributed_evenly',
