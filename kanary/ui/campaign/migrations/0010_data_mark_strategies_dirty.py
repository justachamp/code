...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Mark all Strategies cache_is_dirty == False in order to reload cache."
        for strategy in orm['campaign.Strategy'].objects.all():
            strategy.cache_is_dirty = False
            strategy.save()

    def backwards(self, orm):
        "We don't need a reverse migration here."
