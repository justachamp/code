...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SegmentProximicSafetyLevel'
        db.create_table(u'targeting_segmentproximicsafetylevel', (
        ...
        db.send_create_signal(u'targeting', ['SegmentProximicSafetyLevel'])


        # Changing field 'SegmentProximicMaturityRating.description'
        db.alter_column(u'targeting_segmentproximicmaturityrating', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting model 'SegmentProximicSafetyLevel'
        db.delete_table(u'targeting_segmentproximicsafetylevel')


        # Changing field 'SegmentProximicMaturityRating.description'
        db.alter_column(u'targeting_segmentproximicmaturityrating', 'description', self.gf('django.db.models.fields.CharField')(max_length=300))
