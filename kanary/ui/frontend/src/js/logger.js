define(
    ...
    function() {
        ...
        var beQuiet = CONFIG.BE_QUIET || false;
        ...
        if (!window.log) {
          window.log = function() {
            ...
            // IE8
                ...
                typeof console.log == 'object') {
                Function.prototype.call.call(console.log,
            ...
            // IE7 and lower, and other old browsers
              ...
              if (!document.getElementById('firebug-lite')) {
                ...
                // If you run the script locally, point to
                // /path/to/firebug-lite/build/firebug-lite.js
                ...
                setTimeout(function() {
                    log(Array.prototype.slice.call(arguments)); }, 2000);
              }
              else {
                // FBL was included but it hasn't finished loading yet,
                // so try again momentarily
                setTimeout(function() {
