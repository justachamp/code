...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Audience.is_active'
        db.delete_column(u'storage_audience', 'is_active')


    def backwards(self, orm):
        # Adding field 'Audience.is_active'
        db.add_column(u'storage_audience', 'is_active',
