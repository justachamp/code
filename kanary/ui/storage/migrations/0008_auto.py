...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Creative', fields ['name']
        db.create_index(u'storage_creative', ['name'])


    def backwards(self, orm):
        # Removing index on 'Creative', fields ['name']
        db.delete_index(u'storage_creative', ['name'])
    ...
    models = {
        ...
        u'storage.creative': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'05e676df13ebb4cc0b4b54eaf40a230d6ae137d5'", 'unique': 'True', 'max_length': '128'}),
