...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field segment_peer_page_language on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_peer_page_language')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('peer39pagelanguage', models.ForeignKey(orm[u'targeting.peer39pagelanguage'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'peer39pagelanguage_id'])

        # Adding M2M table for field segment_peer_page_language_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_peer_page_language_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('peer39pagelanguage', models.ForeignKey(orm[u'targeting.peer39pagelanguage'], null=False))
        ...
        # Adding M2M table for field segment_peer_contextual on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_peer_contextual')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('peer39contextualsegment', models.ForeignKey(orm[u'targeting.peer39contextualsegment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'peer39contextualsegment_id'])

        # Adding M2M table for field segment_peer_contextual_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_peer_contextual_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('peer39contextualsegment', models.ForeignKey(orm[u'targeting.peer39contextualsegment'], null=False))
        ...
        # Adding M2M table for field segment_peer_brand_protection on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_peer_brand_protection')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('peer39brandprotection', models.ForeignKey(orm[u'targeting.peer39brandprotection'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'peer39brandprotection_id'])

        # Adding M2M table for field segment_peer_brand_protection_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_peer_brand_protection_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('peer39brandprotection', models.ForeignKey(orm[u'targeting.peer39brandprotection'], null=False))
        ...
        # Adding M2M table for field segment_peer_page_quality on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_peer_page_quality')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('peer39pagequality', models.ForeignKey(orm[u'targeting.peer39pagequality'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'peer39pagequality_id'])

        # Adding M2M table for field segment_peer_page_quality_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_peer_page_quality_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('peer39pagequality', models.ForeignKey(orm[u'targeting.peer39pagequality'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field segment_peer_page_language on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_peer_page_language'))

        # Removing M2M table for field segment_peer_page_language_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_peer_page_language_exclude'))

        # Removing M2M table for field segment_peer_contextual on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_peer_contextual'))

        # Removing M2M table for field segment_peer_contextual_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_peer_contextual_exclude'))

        # Removing M2M table for field segment_peer_brand_protection on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_peer_brand_protection'))

        # Removing M2M table for field segment_peer_brand_protection_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_peer_brand_protection_exclude'))

        # Removing M2M table for field segment_peer_page_quality on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_peer_page_quality'))

        # Removing M2M table for field segment_peer_page_quality_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_peer_page_quality_exclude'))
    ...
    models = {
        ...
        u'targeting.peer39brandprotection': {
            ...
            'peer39_id': ('django.db.models.fields.IntegerField', [], {})
        },
