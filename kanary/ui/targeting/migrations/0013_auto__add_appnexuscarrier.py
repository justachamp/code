...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppNexusCarrier'
        db.create_table(u'targeting_appnexuscarrier', (
            ...
            ('country_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30, blank=True)),
            ('country_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=5, blank=True)),
        ))
        db.send_create_signal('targeting', ['AppNexusCarrier'])


    def backwards(self, orm):
        # Deleting model 'AppNexusCarrier'
        db.delete_table(u'targeting_appnexuscarrier')
    ...
    models = {
        ...
        'targeting.appnexuscarrier': {
            ...
            'appnexus_id': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
            'country_code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '5', 'blank': 'True'}),
            'country_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '511'})
        },
