...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'campaign_conversion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='New conversion', max_length=255)),
            ('value', self.gf('ui.fields.SmallDecimalField')(default=1)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaign.Campaign'])),
        ))
        db.send_create_signal(u'campaign', ['Conversion'])


    def backwards(self, orm):
        # Deleting model 'Conversion'
        db.delete_table(u'campaign_conversion')
