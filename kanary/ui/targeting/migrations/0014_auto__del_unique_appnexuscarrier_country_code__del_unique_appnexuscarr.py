...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'AppNexusCarrier', fields ['country_name']
        db.delete_unique(u'targeting_appnexuscarrier', ['country_name'])

        # Removing unique constraint on 'AppNexusCarrier', fields ['country_code']
        db.delete_unique(u'targeting_appnexuscarrier', ['country_code'])

        # Adding unique constraint on 'AppNexusCarrier', fields ['name', 'country_code']
        db.create_unique(u'targeting_appnexuscarrier', ['name', 'country_code'])

        # Adding unique constraint on 'AppNexusCarrier', fields ['name', 'country_name']
        db.create_unique(u'targeting_appnexuscarrier', ['name', 'country_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'AppNexusCarrier', fields ['name', 'country_name']
        db.delete_unique(u'targeting_appnexuscarrier', ['name', 'country_name'])

        # Removing unique constraint on 'AppNexusCarrier', fields ['name', 'country_code']
        db.delete_unique(u'targeting_appnexuscarrier', ['name', 'country_code'])

        # Adding unique constraint on 'AppNexusCarrier', fields ['country_code']
        db.create_unique(u'targeting_appnexuscarrier', ['country_code'])

        # Adding unique constraint on 'AppNexusCarrier', fields ['country_name']
        db.create_unique(u'targeting_appnexuscarrier', ['country_name'])
