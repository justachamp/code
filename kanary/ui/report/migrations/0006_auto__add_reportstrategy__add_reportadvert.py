...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'report_reportstrategy', (
            ...
            ('ecpm', self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True)),
            ('ctr', self.gf('django.db.models.fields.FloatField')(default=0, db_index=True)),
            ('ecpc', self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True)),
            ('conv_rate', self.gf('django.db.models.fields.FloatField')(default=0, db_index=True)),
            ('ecpa', self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True)),
            ('net_earned', self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True)),
            ('roi', self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True)),
            ('won_bid_ratio', self.gf('django.db.models.fields.FloatField')(default=0, db_index=True)),
            ('avg_bid', self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True)),
            ('avg_winbid', self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True)),
            ('bids_lost', self.gf('django.db.models.fields.BigIntegerField')(default=0, db_index=True)),
            ('related', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['campaign.Strategy'], to_field='id_random', unique=True)),
        ))
        ...
        db.create_table(u'report_reportadvert', (
            ...
            ('avg_winbid', self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True)),
            ('bids_lost', self.gf('django.db.models.fields.BigIntegerField')(default=0, db_index=True)),
            ('related', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['campaign.Advert'], to_field='id_random', unique=True)),
        ))
        db.send_create_signal(u'report', ['ReportAdvert'])


    def backwards(self, orm):
        # Deleting model 'ReportStrategy'
        db.delete_table(u'report_reportstrategy')

        # Deleting model 'ReportAdvert'
        db.delete_table(u'report_reportadvert')
    ...
    models = {
        ...
        u'report.report': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'selected_metrics': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'start_UTC': ('django.db.models.fields.DateTimeField', [], {}),
