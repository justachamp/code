...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Strategy.is_bid_on_unknown_users'
        db.add_column(u'campaign_strategy', 'is_bid_on_unknown_users',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Strategy.is_bid_on_unknown_users'
        db.delete_column(u'campaign_strategy', 'is_bid_on_unknown_users')
    ...
    models = {
        ...
        u'campaign.strategy': {
            ...
            'is_bid_on_unknown_users': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
