...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailySpendings.data_cost_proximic'
        db.add_column(u'bidding_spendings_dailyspendings', 'data_cost_proximic',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0),
                      keep_default=False)

        # Adding field 'DailySpendings.data_cost_peer39'
        db.add_column(u'bidding_spendings_dailyspendings', 'data_cost_peer39',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DailySpendings.data_cost_proximic'
        db.delete_column(u'bidding_spendings_dailyspendings', 'data_cost_proximic')

        # Deleting field 'DailySpendings.data_cost_peer39'
        db.delete_column(u'bidding_spendings_dailyspendings', 'data_cost_peer39')
