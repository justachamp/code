...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'account_account', 'account_number',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'account_account', 'account_number')


    models = {
        u'account.account': {
            'Meta': {'object_name': 'Account'},
            'account_number': ('django.db.models.fields.IntegerField', [], {'unique': 'True', 'null': 'True'}),
