...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReportStrategy.ecpa'
        db.delete_column(u'report_reportstrategy', 'ecpa')

        # Deleting field 'ReportAdvert.ecpa'
        db.delete_column(u'report_reportadvert', 'ecpa')


    def backwards(self, orm):
        # Adding field 'ReportStrategy.ecpa'
        db.add_column(u'report_reportstrategy', 'ecpa',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.ecpa'
        db.add_column(u'report_reportadvert', 'ecpa',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)
