...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.budget_spent_commission'
        db.add_column(u'campaign_campaign', 'budget_spent_commission',
        ...
        # Adding field 'Strategy.budget_spent_commission'
        db.add_column(u'campaign_strategy', 'budget_spent_commission',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.budget_spent_commission'
        db.delete_column(u'campaign_campaign', 'budget_spent_commission')

        # Deleting field 'Advert.budget_spent_commission'
        db.delete_column(u'campaign_advert', 'budget_spent_commission')

        # Deleting field 'Strategy.budget_spent_commission'
        db.delete_column(u'campaign_strategy', 'budget_spent_commission')
