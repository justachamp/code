...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field content_category_values on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_content_category_values')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('contentcategory', models.ForeignKey(orm[u'targeting.contentcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'contentcategory_id'])

        # Adding M2M table for field content_category_values_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_content_category_values_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('contentcategory', models.ForeignKey(orm[u'targeting.contentcategory'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field content_category_values on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_content_category_values'))

        # Removing M2M table for field content_category_values_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_content_category_values_exclude'))
