...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Strategy.cache_is_dirty'
        db.add_column(u'campaign_strategy', 'cache_is_dirty',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)

        # Adding field 'Strategy.optimized_metric'
        db.add_column(u'campaign_strategy', 'optimized_metric',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Strategy.is_automatically_bidded'
        db.add_column(u'campaign_strategy', 'is_automatically_bidded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Strategy.budget_bid_CPM'
        db.alter_column(u'campaign_strategy', 'budget_bid_CPM', self.gf('ui.fields.CPMDecimalField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Strategy.cache_is_dirty'
        db.delete_column(u'campaign_strategy', 'cache_is_dirty')

        # Deleting field 'Strategy.optimized_metric'
        db.delete_column(u'campaign_strategy', 'optimized_metric')

        # Deleting field 'Strategy.is_automatically_bidded'
        db.delete_column(u'campaign_strategy', 'is_automatically_bidded')


        # Changing field 'Strategy.budget_bid_CPM'
        db.alter_column(u'campaign_strategy', 'budget_bid_CPM', self.gf('ui.fields.CPMDecimalField')(default=0))
    ...
    models = {
        ...
        u'campaign.strategy': {
            ...
            'budget_bid_CPM': ('ui.fields.CPMDecimalField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
