...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SiteRatio.site'
        db.alter_column(u'campaign_siteratio', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaign.Site'], on_delete=models.PROTECT))

        # Changing field 'Campaign.landing_site'
        db.alter_column(u'campaign_campaign', 'landing_site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaign.Site'], on_delete=models.PROTECT))

        # Changing field 'Advert.landing_site'
        db.alter_column(u'campaign_advert', 'landing_site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaign.Site'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'SiteRatio.site'
        db.alter_column(u'campaign_siteratio', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Site'], on_delete=models.PROTECT))

        # Changing field 'Campaign.landing_site'
        db.alter_column(u'campaign_campaign', 'landing_site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Site'], on_delete=models.PROTECT))

        # Changing field 'Advert.landing_site'
        db.alter_column(u'campaign_advert', 'landing_site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Site'], null=True, on_delete=models.PROTECT))
    ...
    models = {
        ...
        u'campaign.advert': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'5435d9c0fa154f6790cde3f0ea0ab241f5fff5c4'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'campaign.campaign': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'be5111fa79aa074ba7203a08d778d7ab65cfa6f9'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'campaign.strategy': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'1b1fd6fc925efd7df9593791721b9f856a32acdc'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'storage.creative': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'252a370d62d96dba18eb89f28584a751db953909'", 'unique': 'True', 'max_length': '128'}),
