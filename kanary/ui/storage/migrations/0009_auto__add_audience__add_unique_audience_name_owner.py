...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'storage_audience', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('id_random', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Account'])),
        ))
        db.send_create_signal(u'storage', ['Audience'])

        # Adding unique constraint on 'Audience', fields ['name', 'owner']
        db.create_unique(u'storage_audience', ['name', 'owner_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Audience', fields ['name', 'owner']
        db.delete_unique(u'storage_audience', ['name', 'owner_id'])

        # Deleting model 'Audience'
        db.delete_table(u'storage_audience')
