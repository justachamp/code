...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReportStrategy.roi'
        db.delete_column(u'report_reportstrategy', 'roi')

        # Deleting field 'ReportStrategy.won_bid_ratio'
        db.delete_column(u'report_reportstrategy', 'won_bid_ratio')

        # Deleting field 'ReportStrategy.ecpm'
        db.delete_column(u'report_reportstrategy', 'ecpm')

        # Deleting field 'ReportStrategy.ecpc'
        db.delete_column(u'report_reportstrategy', 'ecpc')

        # Deleting field 'ReportStrategy.avg_winbid'
        db.delete_column(u'report_reportstrategy', 'avg_winbid')

        # Deleting field 'ReportStrategy.avg_bid'
        db.delete_column(u'report_reportstrategy', 'avg_bid')

        # Deleting field 'ReportStrategy.ctr'
        db.delete_column(u'report_reportstrategy', 'ctr')

        # Deleting field 'ReportStrategy.conv_rate'
        db.delete_column(u'report_reportstrategy', 'conv_rate')

        # Deleting field 'ReportAdvert.roi'
        db.delete_column(u'report_reportadvert', 'roi')

        # Deleting field 'ReportAdvert.won_bid_ratio'
        db.delete_column(u'report_reportadvert', 'won_bid_ratio')

        # Deleting field 'ReportAdvert.ecpm'
        db.delete_column(u'report_reportadvert', 'ecpm')

        # Deleting field 'ReportAdvert.ecpc'
        db.delete_column(u'report_reportadvert', 'ecpc')

        # Deleting field 'ReportAdvert.avg_winbid'
        db.delete_column(u'report_reportadvert', 'avg_winbid')

        # Deleting field 'ReportAdvert.avg_bid'
        db.delete_column(u'report_reportadvert', 'avg_bid')

        # Deleting field 'ReportAdvert.ctr'
        db.delete_column(u'report_reportadvert', 'ctr')

        # Deleting field 'ReportAdvert.conv_rate'
        db.delete_column(u'report_reportadvert', 'conv_rate')


    def backwards(self, orm):
        # Adding field 'ReportStrategy.roi'
        db.add_column(u'report_reportstrategy', 'roi',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportStrategy.won_bid_ratio'
        db.add_column(u'report_reportstrategy', 'won_bid_ratio',
                      self.gf('django.db.models.fields.FloatField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportStrategy.ecpm'
        db.add_column(u'report_reportstrategy', 'ecpm',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportStrategy.ecpc'
        db.add_column(u'report_reportstrategy', 'ecpc',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportStrategy.avg_winbid'
        db.add_column(u'report_reportstrategy', 'avg_winbid',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportStrategy.avg_bid'
        db.add_column(u'report_reportstrategy', 'avg_bid',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportStrategy.ctr'
        db.add_column(u'report_reportstrategy', 'ctr',
                      self.gf('django.db.models.fields.FloatField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportStrategy.conv_rate'
        db.add_column(u'report_reportstrategy', 'conv_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.roi'
        db.add_column(u'report_reportadvert', 'roi',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.won_bid_ratio'
        db.add_column(u'report_reportadvert', 'won_bid_ratio',
                      self.gf('django.db.models.fields.FloatField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.ecpm'
        db.add_column(u'report_reportadvert', 'ecpm',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.ecpc'
        db.add_column(u'report_reportadvert', 'ecpc',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.avg_winbid'
        db.add_column(u'report_reportadvert', 'avg_winbid',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.avg_bid'
        db.add_column(u'report_reportadvert', 'avg_bid',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.ctr'
        db.add_column(u'report_reportadvert', 'ctr',
                      self.gf('django.db.models.fields.FloatField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.conv_rate'
        db.add_column(u'report_reportadvert', 'conv_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0, db_index=True),
                      keep_default=False)
    ...
    models = {
        u'account.account': {
            ...
            'commission': ('django.db.models.fields.SmallIntegerField', [], {'default': '20'}),
