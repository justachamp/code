...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advert.custom_pixel'
        db.add_column(u'campaign_advert', 'custom_pixel',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advert.custom_pixel'
        db.delete_column(u'campaign_advert', 'custom_pixel')
