...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SegmentProximicMaturityRating.description'
        db.add_column(u'targeting_segmentproximicmaturityrating', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SegmentProximicMaturityRating.description'
        db.delete_column(u'targeting_segmentproximicmaturityrating', 'description')
