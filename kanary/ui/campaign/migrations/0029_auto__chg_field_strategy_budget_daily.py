...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field segment_proximic_maturity_rating on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_proximic_maturity_rating')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('segmentproximicmaturityrating', models.ForeignKey(orm[u'targeting.segmentproximicmaturityrating'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'segmentproximicmaturityrating_id'])

        # Adding M2M table for field segment_proximic_maturity_rating_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_proximic_maturity_rating_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('segmentproximicmaturityrating', models.ForeignKey(orm[u'targeting.segmentproximicmaturityrating'], null=False))
        ...
        # Changing field 'Strategy.budget_daily'
        db.alter_column(u'campaign_strategy', 'budget_daily', self.gf('ui.fields.BudgetDecimalField')(null=True))

    def backwards(self, orm):
        # Removing M2M table for field segment_proximic_maturity_rating on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_proximic_maturity_rating'))

        # Removing M2M table for field segment_proximic_maturity_rating_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_proximic_maturity_rating_exclude'))


        # Changing field 'Strategy.budget_daily'
        db.alter_column(u'campaign_strategy', 'budget_daily', self.gf('ui.fields.BudgetDecimalField')(default=None))
    ...
    models = {
        ...
        u'targeting.segmentproximicmaturityrating': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'SegmentProximicMaturityRating'},
