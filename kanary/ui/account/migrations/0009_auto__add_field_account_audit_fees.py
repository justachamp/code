...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.audit_fees'
        db.add_column(u'account_account', 'audit_fees',
                      self.gf('ui.fields.BudgetDecimalField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.audit_fees'
        db.delete_column(u'account_account', 'audit_fees')
