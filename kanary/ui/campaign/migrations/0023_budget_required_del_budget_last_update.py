...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campaign.budget_last_update'
        db.delete_column(u'campaign_campaign', 'budget_last_update')

        # Deleting field 'Advert.budget_last_update'
        db.delete_column(u'campaign_advert', 'budget_last_update')

        # Deleting field 'Strategy.budget_last_update'
        db.delete_column(u'campaign_strategy', 'budget_last_update')


        # Changing field 'Strategy.budget_daily'
        db.alter_column(u'campaign_strategy', 'budget_daily', self.gf('ui.fields.BudgetDecimalField')(default=0))

    def backwards(self, orm):
        # Adding field 'Campaign.budget_last_update'
        db.add_column(u'campaign_campaign', 'budget_last_update',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Advert.budget_last_update'
        db.add_column(u'campaign_advert', 'budget_last_update',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Strategy.budget_last_update'
        db.add_column(u'campaign_strategy', 'budget_last_update',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)
    ...
    models = {
        ...
        u'campaign.strategy': {
            ...
            'budget_daily': ('ui.fields.BudgetDecimalField', [], {}),
