...
//                "</div>";
            ...
            var drop = "<div class='dropdown bootstrap-select'>" +
                            "<a class='dropdown-toggle arrow-down dropdown-toggle' data-toggle='dropdown' href='#'><span class='filter-option'></span></a>" +
                            "<ul class='dropdown-menu' role='menu'>" +
                            "</ul>" +
                        "</div>";
        ...
        setSize:function() {
            ...
            if (this.options.size == 'auto' && !this.$newElement.hasClass('open')) {
                function getSize() {
                    var selectOffset_top = _this.$newElement.offset().top;
                    var windowHeight = window.innerHeight;
                    var menuExtras = menuPadding + parseInt(menu.css('margin-top')) + parseInt(menu.css('margin-bottom')) + 2;
                    var selectOffset_bot = windowHeight - selectOffset_top - selectHeight;
                    menuHeight = selectOffset_bot - menuExtras - 50; // 50px fixed header
                    _this.$newElement.toggleClass('dropup', (selectOffset_top > selectOffset_bot) && ((menuHeight - menuExtras) < menu.height()));
                    if (_this.$newElement.hasClass('dropup')) {
                        menuHeight = selectOffset_top - menuExtras - 50; // 50px fixed header
                    }
