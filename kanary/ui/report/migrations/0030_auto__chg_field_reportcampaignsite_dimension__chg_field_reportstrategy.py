...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReportCampaignSite.dimension'
        db.alter_column(u'report_reportcampaignsite', 'dimension', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True))

        # Changing field 'ReportStrategySite.dimension'
        db.alter_column(u'report_reportstrategysite', 'dimension', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'ReportCampaignSite.dimension'
        db.alter_column(u'report_reportcampaignsite', 'dimension', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'report.reportcampaignsite': {
            ...
            'conv_value': ('ui.fields.BudgetSpentDecimalField', [], {'default': '0'}),
            'data_cost_value': ('ui.fields.BudgetSpentDecimalField', [], {'default': '0'}),
            'dimension': ('django.db.models.fields.URLField', [], {'max_length': '2000', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imp': ('ui.fields.BigDecimalField', [], {'default': '0'}),
            'imp_value': ('ui.fields.BudgetSpentDecimalField', [], {'default': '0'}),
            'related': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['campaign.Campaign']", 'to_field': "'id_random'"}),
