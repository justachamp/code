...
class Migration(SchemaMigration):
    depends_on = (('notification', '0005_auto__del_field_event_report_1_name__del_field_event_report_1'),)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'report_report', (
            ...
            ('selected_metrics', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
