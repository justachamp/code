...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Brand.appnexus_access_status'
        db.alter_column(u'storage_brand', 'appnexus_access_status', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Brand.appnexus_access_status'
        db.alter_column(u'storage_brand', 'appnexus_access_status', self.gf('django.db.models.fields.CharField')(max_length=1))
