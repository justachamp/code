...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Strategy.is_distributed_evenly'
        db.add_column(u'campaign_strategy', 'is_distributed_evenly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Strategy.is_distributed_evenly'
        db.delete_column(u'campaign_strategy', 'is_distributed_evenly')
