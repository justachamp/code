...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field segment_proximic_safety_level on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_proximic_safety_level')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('segmentproximicsafetylevel', models.ForeignKey(orm[u'targeting.segmentproximicsafetylevel'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'segmentproximicsafetylevel_id'])

        # Adding M2M table for field segment_proximic_safety_level_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_proximic_safety_level_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('segmentproximicsafetylevel', models.ForeignKey(orm[u'targeting.segmentproximicsafetylevel'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field segment_proximic_safety_level on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_proximic_safety_level'))

        # Removing M2M table for field segment_proximic_safety_level_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_proximic_safety_level_exclude'))
