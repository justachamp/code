...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ReportAdvert', fields ['related']
        db.delete_unique(u'report_reportadvert', ['related_id'])

        # Removing unique constraint on 'ReportStrategy', fields ['related']
        db.delete_unique(u'report_reportstrategy', ['related_id'])


        # Changing field 'ReportStrategy.related'
        db.alter_column(u'report_reportstrategy', 'related_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaign.Strategy'], to_field='id_random'))
        # Adding unique constraint on 'ReportStrategy', fields ['related', 'time']
        db.create_unique(u'report_reportstrategy', ['related_id', 'time'])


        # Changing field 'ReportAdvert.related'
        db.alter_column(u'report_reportadvert', 'related_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaign.Advert'], to_field='id_random'))
        # Adding unique constraint on 'ReportAdvert', fields ['related', 'time']
        db.create_unique(u'report_reportadvert', ['related_id', 'time'])


    def backwards(self, orm):
        # Removing unique constraint on 'ReportAdvert', fields ['related', 'time']
        db.delete_unique(u'report_reportadvert', ['related_id', 'time'])

        # Removing unique constraint on 'ReportStrategy', fields ['related', 'time']
        db.delete_unique(u'report_reportstrategy', ['related_id', 'time'])


        # Changing field 'ReportStrategy.related'
        db.alter_column(u'report_reportstrategy', 'related_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['campaign.Strategy'], to_field='id_random', unique=True))
        # Adding unique constraint on 'ReportStrategy', fields ['related']
        db.create_unique(u'report_reportstrategy', ['related_id'])


        # Changing field 'ReportAdvert.related'
        db.alter_column(u'report_reportadvert', 'related_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['campaign.Advert'], to_field='id_random', unique=True))
        # Adding unique constraint on 'ReportAdvert', fields ['related']
        db.create_unique(u'report_reportadvert', ['related_id'])
