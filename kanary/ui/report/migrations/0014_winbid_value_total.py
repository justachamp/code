...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ReportStrategy = orm["report.ReportStrategy"]
        ReportAdvert = orm["report.ReportAdvert"]

        for report in (ReportAdvert, ReportStrategy):
            report.objects.all().update(
                winbid_value_total=F("winbid_value") + F("commission_value")
            )
