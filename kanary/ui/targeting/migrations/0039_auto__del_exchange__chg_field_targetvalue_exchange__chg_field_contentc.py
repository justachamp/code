...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'TargetValue.exchange' to match new field type.
        db.rename_column(u'targeting_targetvalue', 'exchange_id', 'exchange')
        # Changing field 'TargetValue.exchange'
        db.alter_column(u'targeting_targetvalue', 'exchange', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Renaming column for 'ContentCategoryValue.exchange' to match new field type.
        db.rename_column(u'targeting_contentcategoryvalue', 'exchange_id', 'exchange')
        # Changing field 'ContentCategoryValue.exchange'
        db.alter_column(u'targeting_contentcategoryvalue', 'exchange', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    def backwards(self, orm):
        ...
        # Renaming column for 'TargetValue.exchange' to match new field type.
        db.rename_column(u'targeting_targetvalue', 'exchange', 'exchange_id')
        # Changing field 'TargetValue.exchange'
        db.alter_column(u'targeting_targetvalue', 'exchange_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targeting.Exchange'], null=True))

        # Renaming column for 'ContentCategoryValue.exchange' to match new field type.
        db.rename_column(u'targeting_contentcategoryvalue', 'exchange', 'exchange_id')
        # Changing field 'ContentCategoryValue.exchange'
        db.alter_column(u'targeting_contentcategoryvalue', 'exchange_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['targeting.Exchange'], null=True))
