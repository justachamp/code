...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Creative.destination'
        db.add_column(u'storage_creative', 'destination',
                      self.gf('django.db.models.fields.CharField')(default='d', max_length=1),
                      keep_default=False)


        # Changing field 'Creative.appnexus_status'
        db.alter_column(u'storage_creative', 'appnexus_status', self.gf('django.db.models.fields.CharField')(max_length=2))
        # Deleting field 'CreativeImage.source_type'
        db.delete_column(u'storage_creativeimage', 'source_type')


    def backwards(self, orm):
        # Deleting field 'Creative.destination'
        db.delete_column(u'storage_creative', 'destination')


        # Changing field 'Creative.appnexus_status'
        db.alter_column(u'storage_creative', 'appnexus_status', self.gf('django.db.models.fields.CharField')(max_length=1))
        # Adding field 'CreativeImage.source_type'
        db.add_column(u'storage_creativeimage', 'source_type',
                      self.gf('django.db.models.fields.CharField')(default='appnexus', max_length=20),
                      keep_default=False)
    ...
    models = {
        ...
        u'storage.creative': {
            ...
            'destination': ('django.db.models.fields.CharField', [], {'default': "'d'", 'max_length': '1'}),
        ...
        u'storage.creativeimage': {
            ...
            'body': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '90', 'null': 'True'}),
            u'creative_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['storage.Creative']", 'unique': 'True', 'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'title': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '25', 'null': 'True'})
        },
