...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Audience.cache_is_dirty'
        db.add_column(u'storage_audience', 'cache_is_dirty',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Audience.cache_is_dirty'
        db.delete_column(u'storage_audience', 'cache_is_dirty')
