...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportStrategy.data_cost_value'
        db.add_column(u'report_reportstrategy', 'data_cost_value',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'ReportAdvert.data_cost_value'
        db.add_column(u'report_reportadvert', 'data_cost_value',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportStrategy.data_cost_value'
        db.delete_column(u'report_reportstrategy', 'data_cost_value')

        # Deleting field 'ReportAdvert.data_cost_value'
        db.delete_column(u'report_reportadvert', 'data_cost_value')
    ...
    models = {
        ...
        u'report.reportadvert': {
            ...
            'related': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reports'", 'to_field': "'id_random'", 'to': u"orm['campaign.Advert']"}),
        ...
        u'report.reportstrategy': {
            ...
            'imp': ('django.db.models.fields.BigIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'net_earned': ('ui.fields.BudgetSpentDecimalField', [], {'default': '0', 'db_index': 'True'}),
            'related': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reports'", 'to_field': "'id_random'", 'to': u"orm['campaign.Strategy']"}),
            'time': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'winbid': ('django.db.models.fields.BigIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'winbid_value': ('ui.fields.BudgetSpentDecimalField', [], {'default': '0', 'db_index': 'True'}),
            'winbid_value_total': ('ui.fields.BudgetSpentDecimalField', [], {'default': '0', 'db_index': 'True'})
