...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SegmentProximicMaturityRating'
        db.create_table(u'targeting_segmentproximicmaturityrating', (
        ...
        db.send_create_signal(u'targeting', ['SegmentProximicMaturityRating'])


    def backwards(self, orm):
        # Deleting model 'SegmentProximicMaturityRating'
        db.delete_table(u'targeting_segmentproximicmaturityrating')
