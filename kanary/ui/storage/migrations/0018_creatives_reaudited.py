...
def creatives_to_no_audit(orm):
    for creative in orm['storage.Creative'].objects.filter(appnexus_status__in=['p', 'a']):
        creative.to_audit = False
        creative.appnexus_status = 'n'  # audit default
        creative.save()
