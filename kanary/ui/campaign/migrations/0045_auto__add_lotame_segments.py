...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field segment_lotame_demographic on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_lotame_demographic')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('lotamedemographic', models.ForeignKey(orm[u'targeting.lotamedemographic'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'lotamedemographic_id'])

        # Adding M2M table for field segment_lotame_demographic_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_lotame_demographic_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('lotamedemographic', models.ForeignKey(orm[u'targeting.lotamedemographic'], null=False))
        ...
        # Adding M2M table for field segment_lotame_advanced_demographic on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_lotame_advanced_demographic')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('lotameadvanceddemographic', models.ForeignKey(orm[u'targeting.lotameadvanceddemographic'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'lotameadvanceddemographic_id'])

        # Adding M2M table for field segment_lotame_advanced_demographic_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_lotame_advanced_demographic_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('lotameadvanceddemographic', models.ForeignKey(orm[u'targeting.lotameadvanceddemographic'], null=False))
        ...
        # Adding M2M table for field segment_lotame_behavioral_interest on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_lotame_behavioral_interest')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('lotamebehavioralinterest', models.ForeignKey(orm[u'targeting.lotamebehavioralinterest'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'lotamebehavioralinterest_id'])

        # Adding M2M table for field segment_lotame_behavioral_interest_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_lotame_behavioral_interest_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('lotamebehavioralinterest', models.ForeignKey(orm[u'targeting.lotamebehavioralinterest'], null=False))
        ...
        # Adding M2M table for field segment_lotame_influencers on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_lotame_influencers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('lotameinfluencers', models.ForeignKey(orm[u'targeting.lotameinfluencers'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'lotameinfluencers_id'])

        # Adding M2M table for field segment_lotame_influencers_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_lotame_influencers_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('lotameinfluencers', models.ForeignKey(orm[u'targeting.lotameinfluencers'], null=False))
        ...
        # Adding M2M table for field segment_lotame_offline on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_lotame_offline')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('lotameoffline', models.ForeignKey(orm[u'targeting.lotameoffline'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'lotameoffline_id'])

        # Adding M2M table for field segment_lotame_offline_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_segment_lotame_offline_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('lotameoffline', models.ForeignKey(orm[u'targeting.lotameoffline'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field segment_lotame_demographic on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_lotame_demographic'))

        # Removing M2M table for field segment_lotame_demographic_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_lotame_demographic_exclude'))

        # Removing M2M table for field segment_lotame_advanced_demographic on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_lotame_advanced_demographic'))

        # Removing M2M table for field segment_lotame_advanced_demographic_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_lotame_advanced_demographic_exclude'))

        # Removing M2M table for field segment_lotame_behavioral_interest on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_lotame_behavioral_interest'))

        # Removing M2M table for field segment_lotame_behavioral_interest_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_lotame_behavioral_interest_exclude'))

        # Removing M2M table for field segment_lotame_influencers on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_lotame_influencers'))

        # Removing M2M table for field segment_lotame_influencers_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_lotame_influencers_exclude'))

        # Removing M2M table for field segment_lotame_offline on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_lotame_offline'))

        # Removing M2M table for field segment_lotame_offline_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_segment_lotame_offline_exclude'))
    ...
    models = {
        ...
        u'campaign.biddingperiod': {
            'Meta': {'ordering': "['start']", 'object_name': 'BiddingPeriod'},
        ...
        u'campaign.strategy': {
            ...
            'segment_lotame_advanced_demographic': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['targeting.LotameAdvancedDemographic']", 'symmetrical': 'False', 'blank': 'True'}),
