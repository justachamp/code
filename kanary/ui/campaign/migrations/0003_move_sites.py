...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        '''
        Rewrites old site model into new one, ommiting folders

        What's needed in new one, is only the old id, and url.
        Everything else is needless in new requrements, so it's dumped
        '''
        for old_site in orm['storage.Site'].objects.all():
            if not old_site.is_folder:
                new_site = orm['campaign.Site'].objects.create(id=old_site.id,
                                                               owner=old_site.owner,
                                                               url=old_site.url)
                new_site.save()
    ...
    models = {
        ...
        u'campaign.advert': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'864747fd899cd9acf426dbfdb120a4c49c1071fe'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'campaign.campaign': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'a0fed7ad82286c2c89b0c52aec0007b2c0b532bc'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'campaign.strategy': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'acbd33a7ed18a079faea5226c7412d9caef67739'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'storage.creative': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'c897026118184c2f99827d98b7d6548e9c71383b'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'storage.site': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'3f53ad1383e79d6caca62e8f8c960285ece55c34'", 'unique': 'True', 'max_length': '128'}),
            'is_folder': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
