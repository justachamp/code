...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # renaming target value category from age_groups to age_group
        orm['targeting.TargetValue'].objects.filter(category='age_groups').update(category='age_group')

    def backwards(self, orm):
        "Write your backwards methods here."
        orm['targeting.TargetValue'].objects.filter(category='age_group').update(category='age_groups')
