...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Creative.destination'
        db.alter_column(u'storage_creative', 'destination', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Creative.destination'
        db.alter_column(u'storage_creative', 'destination', self.gf('django.db.models.fields.CharField')(max_length=1))
