...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campaign.is_active'
        db.delete_column(u'campaign_campaign', 'is_active')

        # Deleting field 'Strategy.is_active'
        db.delete_column(u'campaign_strategy', 'is_active')


    def backwards(self, orm):
        # Adding field 'Campaign.is_active'
        db.add_column(u'campaign_campaign', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Strategy.is_active'
        db.add_column(u'campaign_strategy', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
