...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'account_account', 'account_number', self.gf('django.db.models.fields.IntegerField')(default=None, unique=True))

    def backwards(self, orm):

        # Changing field 'Account.account_number'
        db.alter_column(u'account_account', 'account_number', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
