...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        SegmentProximicMaturityRating = orm['targeting.SegmentProximicMaturityRating']
        ...
        for name, description in NAME_AND_DESCRIPTION:
            SegmentProximicMaturityRating.objects.filter(name=name)\
