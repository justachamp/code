...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Creative.landing_site_url'
        db.alter_column(u'storage_creative', 'landing_site_url', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'Creative.landing_site_url'
        db.alter_column(u'storage_creative', 'landing_site_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
