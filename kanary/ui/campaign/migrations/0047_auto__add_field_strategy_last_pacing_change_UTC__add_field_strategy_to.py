...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Strategy.last_pacing_change_UTC'
        db.add_column(u'campaign_strategy', 'last_pacing_change_UTC',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Strategy.total_spent_at_pacing_start'
        db.add_column(u'campaign_strategy', 'total_spent_at_pacing_start',
                      self.gf('ui.fields.BudgetDecimalField')(null=True),
                      keep_default=False)

        # Adding field 'Strategy.daily_spent_at_pacing_start'
        db.add_column(u'campaign_strategy', 'daily_spent_at_pacing_start',
                      self.gf('ui.fields.BudgetDecimalField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Strategy.last_pacing_change_UTC'
        db.delete_column(u'campaign_strategy', 'last_pacing_change_UTC')

        # Deleting field 'Strategy.total_spent_at_pacing_start'
        db.delete_column(u'campaign_strategy', 'total_spent_at_pacing_start')

        # Deleting field 'Strategy.daily_spent_at_pacing_start'
        db.delete_column(u'campaign_strategy', 'daily_spent_at_pacing_start')
    ...
    models = {
        ...
        u'campaign.advert': {
            ...
            'custom_pixel': ('django.db.models.fields.URLField', [], {'max_length': '2000', 'null': 'True'}),
        ...
        u'campaign.site': {
            ...
            'url': ('django.db.models.fields.URLField', [], {'max_length': '2000', 'null': 'True'})
        },
        ...
        u'campaign.strategy': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'daily_spent_at_pacing_start': ('ui.fields.BudgetDecimalField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
            ...
            'last_pacing_change_UTC': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'total_spent_at_pacing_start': ('ui.fields.BudgetDecimalField', [], {'null': 'True'}),
        ...
        u'targeting.targetvalue': {
            ...
            'exchange': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
