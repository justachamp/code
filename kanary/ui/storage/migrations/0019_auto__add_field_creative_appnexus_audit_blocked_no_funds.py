...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Creative.appnexus_audit_blocked_no_funds'
        db.add_column(u'storage_creative', 'appnexus_audit_blocked_no_funds',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Creative.appnexus_audit_blocked_no_funds'
        db.delete_column(u'storage_creative', 'appnexus_audit_blocked_no_funds')
