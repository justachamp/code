...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReportCampaign'
        db.create_table(u'report_reportcampaign', (
        ...
        db.send_create_signal(u'report', ['ReportCampaign'])

        # Adding unique constraint on 'ReportCampaign', fields ['related', 'time']
        db.create_unique(u'report_reportcampaign', ['related_id', 'time'])


    def backwards(self, orm):
        # Removing unique constraint on 'ReportCampaign', fields ['related', 'time']
        db.delete_unique(u'report_reportcampaign', ['related_id', 'time'])

        # Deleting model 'ReportCampaign'
        db.delete_table(u'report_reportcampaign')
