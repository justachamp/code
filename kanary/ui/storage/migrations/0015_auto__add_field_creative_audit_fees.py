...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Creative.audit_fees'
        db.add_column(u'storage_creative', 'audit_fees',
                      self.gf('ui.fields.BudgetDecimalField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Creative.audit_fees'
        db.delete_column(u'storage_creative', 'audit_fees')
