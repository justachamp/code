...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.is_paused'
        db.add_column(u'campaign_campaign', 'is_paused',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Strategy.is_paused'
        db.add_column(u'campaign_strategy', 'is_paused',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.is_paused'
        db.delete_column(u'campaign_campaign', 'is_paused')

        # Deleting field 'Strategy.is_paused'
        db.delete_column(u'campaign_strategy', 'is_paused')
