...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Brand'
        db.create_table(u'storage_brand', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('brand_id', self.gf('django.db.models.fields.IntegerField')()),
            ('thirdparty_page_id', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('appnexus_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True)),
            ('appnexus_access_status', self.gf('django.db.models.fields.CharField')(default='p', max_length=1)),
            ('check_access_status', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Account'])),
        ))
        db.send_create_signal(u'storage', ['Brand'])


    def backwards(self, orm):
        # Deleting model 'Brand'
        db.delete_table(u'storage_brand')
    ...
    models = {
        ...
        u'storage.brand': {
            ...
            'appnexus_access_status': ('django.db.models.fields.CharField', [], {'default': "'p'", 'max_length': '1'}),
