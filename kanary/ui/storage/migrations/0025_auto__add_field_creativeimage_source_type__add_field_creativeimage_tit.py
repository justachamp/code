...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CreativeImage.title'
        db.add_column(u'storage_creativeimage', 'title',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=25, null=True),
                      keep_default=False)

        # Adding field 'CreativeImage.body'
        db.add_column(u'storage_creativeimage', 'body',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CreativeImage.title'
        db.delete_column(u'storage_creativeimage', 'title')

        # Deleting field 'CreativeImage.body'
        db.delete_column(u'storage_creativeimage', 'body')
    ...
    models = {
        ...
        u'storage.creativeimage': {
            ...
            'source_type': ('django.db.models.fields.CharField', [], {'default': "'appnexus'", 'max_length': '20'}),
