...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Strategy.keywords_exclude'
        db.delete_column(u'campaign_strategy', 'keywords_exclude')

        # Deleting field 'Strategy.keywords'
        db.delete_column(u'campaign_strategy', 'keywords')

        # Deleting field 'Strategy.is_targeted_keywords'
        db.delete_column(u'campaign_strategy', 'is_targeted_keywords')


    def backwards(self, orm):
        # Adding field 'Strategy.keywords_exclude'
        db.add_column(u'campaign_strategy', 'keywords_exclude',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Strategy.keywords'
        db.add_column(u'campaign_strategy', 'keywords',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Strategy.is_targeted_keywords'
        db.add_column(u'campaign_strategy', 'is_targeted_keywords',
