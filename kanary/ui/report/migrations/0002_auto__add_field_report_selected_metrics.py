...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.selected_metrics'
        db.add_column(u'report_report', 'selected_metrics',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.selected_metrics'
        db.delete_column(u'report_report', 'selected_metrics')
    ...
    models = {
        ...
        u'campaign.campaign': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'ccfad808a568a3a1fad0fbf0633167dbab382744'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'campaign.strategy': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'b2aa2c2da06b6e3c178161b4f6fb19ac7c52afdc'", 'unique': 'True', 'max_length': '128'}),
