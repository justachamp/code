...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Creative', fields ['is_deleted']
        db.create_index(u'storage_creative', ['is_deleted'])

        # Adding index on 'Audience', fields ['is_deleted']
        db.create_index(u'storage_audience', ['is_deleted'])


    def backwards(self, orm):
        # Removing index on 'Audience', fields ['is_deleted']
        db.delete_index(u'storage_audience', ['is_deleted'])

        # Removing index on 'Creative', fields ['is_deleted']
        db.delete_index(u'storage_creative', ['is_deleted'])
