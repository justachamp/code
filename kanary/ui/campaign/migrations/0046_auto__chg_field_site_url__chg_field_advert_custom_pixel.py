...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'campaign_site', 'url', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True))

        # Changing field 'Advert.custom_pixel'
        db.alter_column(u'campaign_advert', 'custom_pixel', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'Site.url'
        db.alter_column(u'campaign_site', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Advert.custom_pixel'
        db.alter_column(u'campaign_advert', 'custom_pixel', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
