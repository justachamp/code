...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field audiences on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_audiences')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('audience', models.ForeignKey(orm[u'storage.audience'], null=False))
        ))
        db.create_unique(m2m_table_name, ['strategy_id', 'audience_id'])

        # Adding M2M table for field audiences_exclude on 'Strategy'
        m2m_table_name = db.shorten_name(u'campaign_strategy_audiences_exclude')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('strategy', models.ForeignKey(orm[u'campaign.strategy'], null=False)),
            ('audience', models.ForeignKey(orm[u'storage.audience'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field audiences on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_audiences'))

        # Removing M2M table for field audiences_exclude on 'Strategy'
        db.delete_table(db.shorten_name(u'campaign_strategy_audiences_exclude'))
