...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Advert.created'
        db.delete_column(u'campaign_advert', 'created')

        # Deleting field 'Advert.modified'
        db.delete_column(u'campaign_advert', 'modified')

        # Deleting field 'Advert.budget_spent_commission'
        db.delete_column(u'campaign_advert', 'budget_spent_commission')

        # Deleting field 'Advert.budget_spent'
        db.delete_column(u'campaign_advert', 'budget_spent')


    def backwards(self, orm):
        # Adding field 'Advert.created'
        db.add_column(u'campaign_advert', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Advert.modified'
        db.add_column(u'campaign_advert', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Advert.budget_spent_commission'
        db.add_column(u'campaign_advert', 'budget_spent_commission',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0),
                      keep_default=False)

        # Adding field 'Advert.budget_spent'
        db.add_column(u'campaign_advert', 'budget_spent',
                      self.gf('ui.fields.BudgetSpentDecimalField')(default=0),
                      keep_default=False)
