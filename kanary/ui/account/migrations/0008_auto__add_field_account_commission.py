...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.commission'
        db.add_column(u'account_account', 'commission',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.commission'
        db.delete_column(u'account_account', 'commission')
    ...
    models = {
        u'account.account': {
            ...
            'commission': ('django.db.models.fields.SmallIntegerField', [], {'default': '0.2'}),
