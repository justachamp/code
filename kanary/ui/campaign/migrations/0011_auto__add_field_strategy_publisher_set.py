...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Strategy.publisher_set'
        db.add_column(u'campaign_strategy', 'publisherset',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['publishers.PublisherSet'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Strategy.publisher_set'
        db.delete_column(u'campaign_strategy', 'publisherset_id')
