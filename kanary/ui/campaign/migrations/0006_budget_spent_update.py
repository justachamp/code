...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ''' Manually changes BudgetSpentDecimalField '''

        field = BudgetSpentDecimalField(default=0)
        columns = (
            ('campaign_advert', 'budget_spent'),
            ('campaign_strategy', 'budget_spent'),
            ('campaign_strategy', 'budget_daily_spent'),
            ('campaign_campaign', 'budget_spent'),
        )
        for table, column in columns:
            db.alter_column(table, column, field, True)
    ...
    models = {
        ...
        u'campaign.advert': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'eec7bb807f6364797aff217cf6d42b5147dadf28'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'campaign.campaign': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'8af10df0654d66e7ab8b88acb3b5463bfdb049df'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'campaign.strategy': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'ba8ae81af9db15b7cbfa69da1d22fff5aec126de'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'storage.creative': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_random': ('django.db.models.fields.CharField', [], {'default': "'95216abac909b2a995c32cf430581c69b02bc8d9'", 'unique': 'True', 'max_length': '128'}),
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
